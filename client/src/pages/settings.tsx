            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  💡 These colors will be applied throughout the app for subjects and difficulty indicators in reviews, calendar, and progress views.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="neobrutalist-card bg-white dark:bg-gray-800 p-4 rounded-xl">
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <p className="text-xs font-bold text-brutal-black dark:text-white mb-2">Streak Restores</p>
