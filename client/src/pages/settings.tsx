        ...
        <div className="p-4">
          ...
          <Card className="neobrutalist-card bg-white dark:bg-gray-800 p-4 rounded-xl">
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <p>Version {(() => {
                console.log('🔍 VITE_BUILD_TYPE:', import.meta.env.VITE_BUILD_TYPE);
                return import.meta.env.VITE_BUILD_TYPE === 'bunny' ? '0.7.15' : 
                       import.meta.env.VITE_BUILD_TYPE === 'debug' ? '0.8.0-dev' : '1.0.0';
              })()}</p>
